...
public class SkipNodeTest {
  ...
  //     //     { new NodeInfo("127.0.0.1:" + 1234, 43,   "11000"), new NodeInfo("127.0.0.1:" +
  // 1234, 59, "11110") },
  //     //     { new NodeInfo("127.0.0.1:" + 1234, 43,   "11000"), new NodeInfo("127.0.0.1:" +
  // 1234, 59, "11110") },
  //     // };
  ...
  //     // SkipNode nodes1[] = {
  //     //     new SkipNode("127.0.0.1:1237", "00000", "27", 1234),
  //     //     new SkipNode("127.0.0.1:1237", "10000", "35", 1235),
  //     //     new SkipNode("127.0.0.1:1237", "11000", "43", 1236),
  //     //     new SkipNode("none"          , "11100", "51", 1237),
  //     //     new SkipNode("127.0.0.1:1237", "11110", "59", 1238),
  //     //     new SkipNode("127.0.0.1:1237", "11111", "67", 1239),
  //     //     new SkipNode("127.0.0.1:1237", "11011", "75", 1240),
  //     // };
  ...
  //     //     try {
  //     //         assertTrue(nodes1[3].lookup[lvl][0] == lookupTable1[lvl][0]);
  //     //         assertTrue(nodes1[3].lookup[lvl][1] == lookupTable1[lvl][1]);
  //     //     } catch (Exception e) {
  ...
  //     //     { new NodeInfo("127.0.0.1:" + 2237, 50,   "00011"), new NodeInfo("127.0.0.1:" +
  // 2237, 52, "00010") },
  //     //     { new NodeInfo("127.0.0.1:" + 2237, 40,   "10000"), new NodeInfo("127.0.0.1:" +
  // 2237, 80, "11111") },
  //     //     { new NodeInfo("127.0.0.1:" + 2237, 0,    "11000"), new NodeInfo("127.0.0.1:" +
  // 2237, 80, "11111") },
  //     //     { null,                                             new NodeInfo("127.0.0.1:" +
  // 2237, 80, "11111") },
  //     //     { null,                                             null},
  //     // };
  ...
  //     // for(int lvl = 0; lvl < 5; lvl++) {
  //     //     try {
  //     //         assertTrue(nodes2[3].lookup[lvl][0] == lookupTable2[lvl][0]);
  //     //         assertTrue(nodes2[3].lookup[lvl][1] == lookupTable2[lvl][1]);
  //     //     } catch (Exception e) {
  //     //         System.out.println("lol");
  ...
  //     //     { null, null},
  //     //     { null,                                            new NodeInfo("127.0.0.1:" + 1339,
  // 67, "11111") },
  //     //     { new NodeInfo("127.0.0.1:" + 1337, 51, "11100"),  new NodeInfo("127.0.0.1:" + 1339,
  // 67, "11111") },
  //     //     { new NodeInfo("127.0.0.1:" + 1337, 51, "11100"),  new NodeInfo("127.0.0.1:" + 1339,
  // 67, "11111") },
  //     //     { new NodeInfo("127.0.0.1:" + 1337, 51, "11100"),  new NodeInfo("127.0.0.1:" + 1339,
  ...
  //     //     { new NodeInfo("127.0.0.1:" + 1335, 35, "10000"), new NodeInfo("127.0.0.1:" + 1337,
  // 51, "11100") },
  //     // };
  ...
  //     //     try {
  //     //         assertTrue(nodes3[2].lookup[lvle][0] == lookupTable3_43[lvle][0]);
  //     //         assertTrue(nodes3[2].lookup[lvle][1] == lookupTable3_43[lvle][1]);
  //     //         assertTrue(nodes3[4].lookup[lvle][0] == lookupTable3_59[lvle][0]);
  //     //         assertTrue(nodes3[4].lookup[lvle][1] == lookupTable3_59[lvle][1]);
  //     //     } catch (Exception e) {
  //     //         System.out.println("lol");
  //     //     }
  //     // }
  ...
  //     NodeInfo lookupTable1[][] = {
  //         { new NodeInfo("127.0.0.1:" + PORT, 13, "10101"), new NodeInfo("127.0.0.1:" + PORT, 16,
  // "00101") },
  //         { new NodeInfo("127.0.0.1:" + PORT, 11, "01100"), new NodeInfo("127.0.0.1:" + PORT, 20,
  // "01110") },
  //         { new NodeInfo("127.0.0.1:" + PORT, 12, "00001"), new NodeInfo("127.0.0.1:" + PORT, 19,
  // "00101") },
  //         { new NodeInfo("127.0.0.1:" + PORT, 13, "00111"), new NodeInfo("127.0.0.1:" + PORT, 17,
  // "00110") },
  ...
  //     RMIInterface server = (RMIInterface) Naming.lookup("//" + "127.0.0.1:" + serverPORT +
  // "/RMIImpl");
